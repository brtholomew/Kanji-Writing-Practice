...
Hint animation speed ranges from 15-100. Note that higher animation speeds can result in certain kanji getting slightly distorted. This is due to limitations with Pygame.
